...
const DEFAULT_PERMISSIONS: Record<string, string[]> = {
  ...
  group_auditor:    ["dashboard","accounting","invoices","expenses","office_expenses","payroll","reports","kpis","documents","notifications","messages"],
  ...
  group_accountant: ["dashboard","accounting","invoices","expenses","office_expenses","payroll","reports","kpis","documents","notifications","petty_cash","messages"],
  // Company-level
  admin:            GROUP_ALL,
  ...
  accountant:       ["dashboard","accounting","invoices","expenses","office_expenses","payroll","reports","services","commissions","notifications","petty_cash","messages"],
  ...
  customer_service: ["dashboard","customers","tasks","services","notifications","messages"],
  ...
  loan_officer:     ["dashboard","customers","tasks","expenses","reports","services","notifications","messages"],
  journalist:       ["dashboard","tasks","documents","reports","services","notifications","messages"],
  media_manager:    ["dashboard","tasks","documents","reports","services","commissions","notifications","messages"],
  media_supervisor: ["dashboard","tasks","documents","reports","services","notifications","messages"],
  staff:            ["dashboard","attendance","leave","expenses","services","notifications","messages"],
};
