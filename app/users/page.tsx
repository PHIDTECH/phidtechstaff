...
const STAFF_POSITIONS = [
  ...
  { value: "loan_officer",      label: "Loan Officer",               color: "cyan"   },
  { value: "journalist",        label: "Journalist",                 color: "orange" },
  { value: "media_manager",     label: "Media Manager",              color: "pink"   },
  { value: "media_supervisor",  label: "Media Supervisor",           color: "purple" },
...
const ALL_PERMISSIONS = [
  ...
  { key: "media_customers",          label: "Media Customers" },
  { key: "business_customers",       label: "Business Customers" },
  { key: "licence_customers",        label: "Licence Customers" },
  ...
  { key: "projected_budget",          label: "Projected Expenses" },
...
const DEFAULT_PERMISSIONS: Record<string, string[]> = {
  ...
  group_auditor:    ["dashboard","accounting","invoices","expenses","office_expenses","payroll","reports","financial_reports","kpis","documents","notifications","messages","media_customers","business_customers","licence_customers","entertainment_customers","movies_customers","debtors","creditors","projected_budget","projected_income"],
  ...
  group_accountant: ["dashboard","accounting","invoices","expenses","office_expenses","payroll","reports","financial_reports","kpis","documents","notifications","petty_cash","messages","debtors","creditors","projected_budget","projected_income"],
  // Company-level
  admin:            GROUP_ALL,
  ...
  accountant:       ["dashboard","accounting","invoices","expenses","office_expenses","payroll","reports","financial_reports","services","commissions","notifications","petty_cash","messages","account_floats","debtors","creditors","projected_budget","projected_income"],
  ...
  procurement:      ["dashboard","vendors","inventory","expenses","tasks","services","notifications","messages"],
  customer_service: ["dashboard","customers","tasks","services","notifications","messages","media_customers","business_customers","licence_customers","entertainment_customers","movies_customers"],
  legal:            ["dashboard","documents","reports","services","notifications","messages"],
  logistics:        ["dashboard","inventory","vendors","tasks","services","notifications","messages"],
  loan_officer:     ["dashboard","customers","tasks","expenses","reports","services","notifications","messages","media_customers","business_customers","licence_customers","entertainment_customers","movies_customers"],
  journalist:       ["dashboard","tasks","documents","reports","services","notifications","messages","media_customers","business_customers","licence_customers","entertainment_customers","movies_customers"],
  media_manager:    ["dashboard","tasks","documents","reports","services","commissions","notifications","messages","media_customers","business_customers","licence_customers","entertainment_customers","movies_customers"],
  media_supervisor: ["dashboard","tasks","documents","reports","services","notifications","messages","media_customers","business_customers","licence_customers","entertainment_customers","movies_customers"],
  staff:            ["dashboard","attendance","leave","expenses","services","notifications","messages","media_customers","business_customers","licence_customers","entertainment_customers","movies_customers"],
};
                ...
                <div className="col-span-2">
                  ...
                  <Select value={form.branchId || "none"} onValueChange={v => setForm(f => ({ ...f, branchId: v === "none" ? "" : v }))}>
                    ...
                    <SelectContent>
                      ...
                      {branchesList.filter(b => b.companyId === form.companyId || b.companyId === "group").map(b => (
                        <SelectItem key={b.id} value={b.id}>📍 {b.name}{b.location ? ` — ${b.location}` : ""}</SelectItem>
                      ))}
                      {branchesList.filter(b => b.companyId === form.companyId || b.companyId === "group").length === 0 && (
